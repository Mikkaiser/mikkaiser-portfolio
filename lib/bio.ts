...
Role: Senior Software Engineer at ACTVET, and Software Development Expert for the EmiratesSkills Software Applications Development skill. Full stack software developer: backend architecture and enterprise systems are the core, but he also builds the front ends (Angular, React, Next.js, TypeScript) and mobile (React Native). Six plus years of experience. Also a technical instructor.
Languages: Portuguese native, professional fluency in English.

EXPERIENCE
ACTVET, Abu Dhabi, Senior Software Engineer, September 2023 to present. Internal platforms in .NET, ASP.NET Core, Next.js, SQL Server and MariaDB supporting 200+ active users. Full .NET stack solutions including C#, ASP.NET Core Web API, Entity Framework Core, WinForms and xUnit for national and international competition training programmes. Secure APIs and CI/CD via GitHub Actions and Azure Pipelines; automated testing with xUnit reduced deployment issues by 30%. Leads technical instruction for more than 500 students and professionals across ATS schools, HCT and Khalifa University. Enterprise software aligned with multi-year business lifecycles.
Radix Engineering and Software, Rio de Janeiro, Full Stack Developer, January to September 2023. Supported 15 microservices and 3+ enterprise platforms in production; stabilised SotreqLink serving around 5,000 internal users and field technicians. Resolved 50+ production incidents a month, reducing recurring failures by 35% and delivering 100+ corrective fixes and feature updates. Backend in ASP.NET Core and ASP.NET MVC, data access via Oracle DB and Redis improving response times 20 to 30%. Cloud and CI/CD on Microsoft Azure, monitoring with Grafana, Loki and Prometheus which cut incident detection time by 40%. Maintained 99.9% availability on Docker and Kubernetes, test coverage to 75%. Shipped a React Native app for 200+ field technicians and integrated SAP workflows.
SENAI Alagoas, Maceio, Full Stack Developer, April 2022 to January 2023. 10+ web and mobile applications for the Federation of Industries; contributed to SENAI Play, a national LMS with 780,000+ active users. REST and GraphQL APIs in NestJS and Node.js, front ends in Angular, TypeScript and SASS. Automated testing with Jest and Jasmine cut production defects 25%. CI/CD on GitLab CI, containerisation with Docker cutting image size 50%. Scrum across cross functional teams, plus 5+ internal training sessions on architecture and best practices.
